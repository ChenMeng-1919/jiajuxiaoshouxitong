        ...
        <div class="kehubh_tj_k">
            ...
            <ul> 
                <li>
                    ...
                    <div class="right"> 
                        <input type="text" name="name" id="name"  required="required"  placeholder="请输入商品类型名" autocomplete="off" class="layui-input">
                ...
                <li>
                    <div class="left"></div>
                    <div class="right"> 
                        <button class="button_qr" onclick="return checkName();">确定添加</button>
                    </div>
                </li>
            </ul> 
            </form>
